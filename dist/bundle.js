...
const calcChanges = (currentCourses) => {
    const snapshotLS = new _helpers_lsWrapper__WEBPACK_IMPORTED_MODULE_1__.LSWrapper(_config__WEBPACK_IMPORTED_MODULE_0__.LOCALSTORAGE_KEY, DEFAULT_LS_DATA);
...
const LOCALSTORAGE_KEY = "oldGrades";
...
/* harmony import */ var _renderChanges__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./renderChanges */ "./src/renderChanges.ts");
/* harmony import */ var _resources_tile_html__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./resources/tile.html */ "./src/resources/tile.html");
...
const extractData = () => $(".ic-DashboardCard__header")
    ...
    .toArray();
const main = async () => {
    (0,_helpers_utils__WEBPACK_IMPORTED_MODULE_2__.debug)("Running");
    if (globalThis.window.OCP_ran === true) {
        (0,_helpers_utils__WEBPACK_IMPORTED_MODULE_2__.debug)("Already ran, stopping");
        return;
    }
    globalThis.window.OCP_ran = true;
    if (globalThis.location.pathname !== "/") {
        (0,_helpers_utils__WEBPACK_IMPORTED_MODULE_2__.debug)("Wrong location");
        return;
    }
    if (!globalThis.location.href.includes("canvas.") &&
        !confirm("This script is only meant to run on canvas. Do you want to continue?")) {
        throw new _helpers_utils__WEBPACK_IMPORTED_MODULE_2__.AlertPanic("Canceled by user");
    }
    // Check for jQuery
    while (typeof jQuery === "undefined") {
        (0,_helpers_utils__WEBPACK_IMPORTED_MODULE_2__.debug)("Waiting for jquery");
        await (0,_helpers_utils__WEBPACK_IMPORTED_MODULE_2__.sleep)(_config__WEBPACK_IMPORTED_MODULE_1__.WAIT_FOR_ELEMENT_DELAY);
    }
    while ($(".bettercanvas-card-grade").length <= 0) {
        (0,_helpers_utils__WEBPACK_IMPORTED_MODULE_2__.debug)("Waiting for grades");
        await (0,_helpers_utils__WEBPACK_IMPORTED_MODULE_2__.sleep)(_config__WEBPACK_IMPORTED_MODULE_1__.WAIT_FOR_ELEMENT_DELAY);
    }
    const gpaButton = $(".bettercanvas-gpa-edit-btn")[0];
    if (gpaButton === undefined) {
        throw new _helpers_utils__WEBPACK_IMPORTED_MODULE_2__.AlertPanic("Couldn't find GPA button.");
    }
    gpaButton.insertAdjacentHTML("afterend", _resources_tile_html__WEBPACK_IMPORTED_MODULE_4__["default"]);
    ...
    (0,_renderChanges__WEBPACK_IMPORTED_MODULE_3__.renderChanges)(changes);
    (0,_helpers_utils__WEBPACK_IMPORTED_MODULE_2__.debug)("Done");
};
void main();
